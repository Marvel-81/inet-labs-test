...
| Компонент | Использование AI | Промпт |
|-----------|------------------|--------|
| **Миграции** | Генерация миграций | "Составь миграцию Laravel для таблицы с полями..." |
| **Blade-шаблоны** | Генерация шаблонов писем | "Составь Blade-шаблоны для писем-уведомлений автору и лиду..." |
| **LeadRequest** | Генерация Request-класса | "Сделай Request для проверки входных данных согласно таблице..." |
| **Ресурсы (API Resources)** | Генерация ресурсов | "Сделай Resource Laravel для такого ответа..." |
| **Тесты** | Генерация тестов | "Сделай Feature/Unit-тесты для проверки функционала..." |
| **GigaChatService** | Интеграция с GigaChat API | "Покажи пример интеграции с GigaChat API" |
| **HealthCheckService** | Проверка статуса приложения | "Реализуй Health Check Service" |
| **Локализация** | Перевод сообщений | "Сделай локализацию для русского и английского языка" |
| **README.md** | Структурирование документации | "Оформи этот Markdown..." |

### Что пришлось исправлять вручную

В большей или меньшей степени — всё. Минимально: миграции, шаблоны, ресурсы, HealthCheckService.
---
